          ...
          <div className="py-16 md:py-24 relative z-10">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/5 flex justify-center">
                <div className="relative bg-white/10 backdrop-blur rounded-lg p-6 w-full max-w-md">
                  <div className="absolute -top-3 -left-3 w-6 h-6 rounded-full bg-yellow-400"></div>
                  <div className="absolute -bottom-3 -right-3 w-6 h-6 rounded-full bg-blue-400"></div>
                  
                  <h3 className="text-xl font-semibold mb-4 text-center">SEO Results We Deliver</h3>
                  
                  <div className="space-y-4">
                    <div className="bg-white/20 backdrop-blur rounded p-3 flex items-center">
                      <div className="w-10 h-10 rounded-full bg-primary-main/30 flex items-center justify-center text-xl mr-3">
                        📈
                      </div>
                      <div>
                        <div className="font-bold text-xl">+187%</div>
                        <div className="text-xs opacity-90">Average Organic Traffic Growth</div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/20 backdrop-blur rounded p-3 flex items-center">
                      ...
                      <div>
                        <div className="font-bold text-xl">Top 10</div>
                        <div className="text-xs opacity-90">Rankings for Key Terms</div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/20 backdrop-blur rounded p-3 flex items-center">
                      ...
                      <div>
                        <div className="font-bold text-xl">12x</div>
                        <div className="text-xs opacity-90">Average ROI on SEO Investment</div>
                      </div>
                    </div>
                  </div>
                </div>
